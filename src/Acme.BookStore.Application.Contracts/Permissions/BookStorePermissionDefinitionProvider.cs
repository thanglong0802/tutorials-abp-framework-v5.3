...
public class BookStorePermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        // var authorGroup = context.AddGroup(BookStorePermissions.GroupName, L("Permission:AuthorStore"));
        var authorPermission = bookStoreGroup.AddPermission(BookStorePermissions.Author.Default, L("Permission:Authors"));
